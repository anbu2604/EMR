...
import '../business-bank-details/bisbank.styles.css';
...
export function Bisbankdetails() {
        ...
        <div className="container-fluid over vh-100 ">
            <div className="row">
                ...
                <div className="col-sm-8 px-0 offset-sm-2 min-vh-100 user-content">
                    ...
                    <h3 className="text-center fw-bold">Business Bank Details
                    </h3>
                            ...
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-sm-7 d-flex justify-content-center">
                                        <button type="button" className="bankbtn"><a className="linkbtn" href="#">Next</a></button>
