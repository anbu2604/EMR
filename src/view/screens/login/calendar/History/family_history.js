...
<div className="container text-center">
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold mt-3">Father:</label>
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold mt-3">Diagnosis Code:</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Mother:</label>
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Diagnosis Code:</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Siblings:</label>
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Diagnosis Code:</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Spouse:</label>
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Diagnosis Code:</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Offspring:</label>
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Diagnosis Code:</label>
