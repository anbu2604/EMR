...
<h4 className="col-4 float-end fw-bold">Life Style</h4>
    ...
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold mt-3">Tobacco:	</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Coffee:	</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Alcohol:</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Recreational Drugs:</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Counseling:</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Exercise Patterns:</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Hazardous Activities:	</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Sleep Patterns:	</label>

    </div>
    <div className="row">
        <label className="col-md-3 col-lg-6 col-sm-12 fw-bold ">Seatbelt Use:	</label>
