            ...
            <li><a class="m-link" href="./Dashborad"><i class="icofont-ui-home fs-5"></i> <span>Dashboard</span></a></li>
              ...
              <li className="collapsed">
                ...
                <ul className="sub-menu collapse show" id="menu-Patient">
                  ...
                  <li><a className="ms-link active" href="./patient_profile">Patient Profile</a></li>
                      ...
                      <div className="row">
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-2 col-md-3 col-sm-12">
                            ...
                            >
                              <option selected>Select</option>
                              <option value={1}>Identifies as Male</option>
                              <option value={2}>Identifies as Female</option>
                              <option value={2}>Female-to-Male (FTM)/Transgender Male/Trans Man</option>
                              <option value={1}>Male-to-Female (MTF)/Transgender Female/Trans Woman</option>
                              <option value={1}>Genderqueer, neither exclusively male nor female</option>
                              <option value={1}>Additional gender category or other, please specify</option>
