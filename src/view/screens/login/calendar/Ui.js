...
import patient from "../calendar/patient/patient";
            ...
            <div className="container-xxl">
              <div className="row g-3 mb-3">
                <div className="col-md-12 col-lg-4 col-xl-4 d-none d-lg-block">
                  <svg id="b142c218-c3ca-487e-979b-dffd11e3a76c" className="cal-img " data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="100%" height="389.35169" viewBox="0 0 532.48525 389.35169">
                        ...
                        <div className="col-md-4 col-sm-6">
                          <div className="card">
                            <div className="card-body ">
                              ...
                              <h6 className="mt-3 mb-0 fw-bold small-14">Total Appointment</h6>
                        ...
                        <div className="col-md-4 col-sm-6">
                          <div className="card">
                            <div className="card-body ">
                              ...
                              <h6 className="mt-3 mb-0 fw-bold small-14">Patients per Doctor</h6>
                        ...
                        <div className="col-md-4 col-sm-6">
                          <div className="card">
                            <div className="card-body ">
                              ...
                              <h6 className="mt-3 mb-0 fw-bold small-14">Covid Patients </h6>
                        ...
                        <div className="col-md-4 col-sm-6">
                          <div className="card">
                            <div className="card-body ">
                              ...
                              <h6 className="mt-3 mb-0 fw-bold small-14">Total Doctor</h6>
                        ...
                        <div className="col-md-4 col-sm-6">
                          <div className="card">
                            <div className="card-body ">
                              ...
                              <h6 className="mt-3 mb-0 fw-bold small-14">Total Nurse </h6>
                ...
                <div className="col-xl-4 col-lg-12 flex-column">
                    ...
                    <div className="card-body">
                      <div className="wrapper">
                        ...
                        <div className="inner-wrap">
                          <form>
                            <div className="mb-3">
                              <input type="text" className="form-control" id="ps-name" placeholder="Enter Name" />
                            </div>
                            <div className="mb-3">
                              <input type="email" className="form-control" id="ps-email" placeholder="Enter Email" />
                            </div>
                            ...
                            <button type="submit" className="btn btn-primary disabled request"> Request appointment <span>On</span>
                  ...
                  <div className="card bg-secondary position-relative">
                    ...
                    <div className="card-body text-center p-4 text-white">
                      <img src="assets/images/profile_av.png" alt="" className="rounded-circle mb-3 img-thumbnail avatar xl shadow-sm" />
                      <div className="d-flex align-items-center justify-content-center">
                        <span className="mb-2 me-3">
                          <a href="#" className="rating-link active"><i className="bi bi-star-fill text-primary" /></a>
                          <a href="#" className="rating-link active"><i className="bi bi-star-fill text-primary" /></a>
                          <a href="#" className="rating-link active"><i className="bi bi-star-fill text-primary" /></a>
                          <a href="#" className="rating-link active"><i className="bi bi-star-fill text-primary" /></a>
                          <a href="#" className="rating-link active"><i className="bi bi-star-half text-primary" /></a>
                        </span>
                      </div>
                      <h5 className="mb-0">Manuella Nevoresky</h5><span className="small">Cardiologists</span>
